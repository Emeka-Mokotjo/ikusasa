  ...
  head: () => ({
    meta: [
      ...
      { title: "Ikusasa — Where emerging talent gets to work" },
      {
        name: "description",
        content:
          "Ikusasa is the South African marketplace connecting students and graduates with businesses for freelance work, internships, and entry-level opportunities.",
      },
      { name: "author", content: "Ikusasa" },

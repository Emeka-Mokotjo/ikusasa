...
function DashboardPlaceholder({ role }: { role: "Student" | "Graduate" | "Business" | "Admin" }) {
    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 text-center">
        <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground">
          <Sparkles className="h-3.5 w-3.5 text-primary" /> You're in!
        </span>
        ...
        <p className="mt-3 text-muted-foreground">
          Account created and onboarding complete. The full dashboard, marketplace, and messaging
          experience ship in the next build phase.
        </p>
